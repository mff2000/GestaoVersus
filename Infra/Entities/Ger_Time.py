...
class Ger_Time(Base):
    ...
    GER_TIME_LIDER_ID = Column(Integer)  # Pode ser chave estrangeira para GER_USUARIOS
    GER_TIME_DT_CRIACAO = Column(DateTime, nullable=False)
    GER_TIME_DT_ALTERACAO = Column(DateTime)
    GER_TIME_DT_EXCLUSAO = Column(DateTime)
