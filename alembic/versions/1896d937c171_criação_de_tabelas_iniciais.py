...
Revision ID: 1896d937c171
Revises: 
Create Date: 2024-07-30 17:51:58.107743
...
def upgrade() -> None:
    ...
    sa.Column('GER_TIME_LIDER_ID', sa.Integer(), nullable=False),
    sa.Column('GER_TIME_DT_CRIACAO', sa.DateTime(), nullable=True),
    sa.Column('GER_TIME_DT_ALTERACAO', sa.DateTime(), nullable=False),
    sa.Column('GER_TIME_DT_EXCLUSAO', sa.DateTime(), nullable=False),
    ...
    sa.Column('PRC_COMPLIANCE_DT_CRIACAO', sa.DateTime(), nullable=True),
    ...
    sa.Column('PRC_MACROPR_DT_CRIACAO', sa.DateTime(), nullable=True),
    sa.Column('PRC_MACROPR_DT_ALTERACAO', sa.DateTime(), nullable=True),
    sa.Column('PRC_MACROPR_DT_EXCLUSAO', sa.DateTime(), nullable=True),
    ...
    op.create_table('PRC_RECURSO_UTILIZ',
    sa.Column('PRC_RECURSO_UTILIZ_ID', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('PRC_RECURSO_UTILIZ_NOME', sa.String(length=256), nullable=True),
    sa.Column('PRC_RECURSO_UTILIZ_DESCRICAO', sa.Text(), nullable=True),
    sa.Column('PRC_RECURSO_UTILIZ_CUSTO_UNIT', sa.Numeric(precision=10, scale=2), nullable=True),
    sa.Column('PRC_RECURSO_UTILIZ_OBSERV', sa.Text(), nullable=True),
    sa.Column('PRC_RECURSO_UTILIZ_DT_CRIACAO', sa.DateTime(), nullable=False),
    sa.Column('PRC_RECURSO_UTILIZ_DT_ALTERACAO', sa.DateTime(), nullable=True),
    sa.Column('PRC_RECURSO_UTILIZ_DT_EXCLUSAO', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('PRC_RECURSO_UTILIZ_ID')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('PRC_RECURSO_UTILIZ')
